!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      var o = {};
      n.r(o),
        n.d(o, "keyboardHandler", function () {
          return N;
        }),
        n.d(o, "mouseHandler", function () {
          return C;
        }),
        n.d(o, "resizeHandler", function () {
          return R;
        }),
        n.d(o, "selectHandler", function () {
          return H;
        }),
        n.d(o, "touchHandler", function () {
          return I;
        }),
        n.d(o, "wheelHandler", function () {
          return B;
        });
      /*! *****************************************************************************
...
***************************************************************************** */
      ...
      function l(t) {
        ...
        return (
          ...
          function (t, n, o) {
            function i(t) {
              t.defaultPrevented || o(t);
            }
            n.split(/\s+/g).forEach(function (n) {
              e.push({ elem: t, eventName: n, handler: i }),
                t.addEventListener(n, i, c());
            });
          }
        );
      }
            ...
            (t.prototype.getEasingDistance = function (t) {
              ...
              return (
                Object.keys(o).forEach(function (t) {
                  for (var i = Math.abs(o[t]) <= 10 ? 0 : o[t]; 0 !== i; )
                    (n[t] += i), (i = (i * e) | 0);
                }),
                n
              );
      ...
      function b(t, e, n) {
        ...
        var i = -1 / 0;
        return function () {
          for (var r = this, s = [], a = 0; a < arguments.length; a++)
            s[a] = arguments[a];
          if (n) {
            var u = Date.now(),
              c = u - i;
            (i = u), c >= e && t.apply(this, s);
          }
          clearTimeout(o),
      ...
      var E,
        T = (function () {
          ...
          return (
            ...
            a([w(0, 1)], t.prototype, "damping", void 0),
            a([w(0, 1 / 0)], t.prototype, "thumbMinSize", void 0),
            a([x], t.prototype, "renderByPixels", void 0),
            a([x], t.prototype, "alwaysShowTracks", void 0),
            a([x], t.prototype, "continuousScrolling", void 0),
            t
          );
        })();
      !(function (t) {
      ...
      var A = (function () {
        ...
        P = (function () {
          function t(t) {
            ...
            (this.xAxis = new S(E.X, e)),
              (this.yAxis = new S(E.Y, e)),
          ...
          return (
            ...
            a([_(300)], t.prototype, "autoHideOnIdle", null),
            t
          );
        })(),
        M = new WeakMap();
      ...
      function C(t) {
          ...
          return e === k.X
            ...
            : e === k.Y
              ? g(
                  (n /
                    (o.container.height +
                      (d.thumb.realSize - d.thumb.displaySize))) *
                    o.content.height,
                  0,
                  i.y,
                ) - r.y
        ...
        function y(t) {
          return h(t, [c.element, c.thumb.element])
            ? k.X
            : h(t, [d.element, d.thumb.element])
              ? k.Y
              : void 0;
        }
        s(a, "click", function (e) {
          if (!n && h(e.target, [c.element, d.element])) {
            var o = e.target,
              i = y(o),
              r = o.getBoundingClientRect(),
              s = f(e);
            if (i === k.X) {
              var a = s.x - r.left - c.thumb.displaySize / 2;
              t.setMomentum(p(i, a), 0);
            }
            i === k.Y &&
              ((a = s.y - r.top - d.thumb.displaySize / 2),
              t.setMomentum(0, p(i, a)));
          }
        }),
          s(a, "mousedown", function (n) {
            if (h(n.target, [c.thumb.element, d.thumb.element])) {
              e = !0;
              var s = n.target,
                u = f(n),
                l = s.getBoundingClientRect();
              (i = y(s)),
                (o = { x: u.x - l.left, y: u.y - l.top }),
                (r = a.getBoundingClientRect()),
                m(t.containerEl, { "-user-select": "none" });
            }
          }),
          s(window, "mousemove", function (s) {
            if (e) {
              ...
              var a = f(s);
              if (i === k.X) {
                var u = a.x - o.x - r.left;
                t.setMomentum(p(i, u), 0);
              }
              i === k.Y && ((u = a.y - o.y - r.top), t.setMomentum(0, p(i, u)));
            }
          }),
          s(window, "mouseup blur", function () {
            (e = n = !1), m(t.containerEl, { "-user-select": "" });
          });
      }
      function R(t) {
        l(t)(window, "resize", b(t.update.bind(t), 300));
      }
      function H(t) {
        var e,
          n = l(t),
        ...
        n(window, "mousemove", function (n) {
          ...
          n(i, "contextmenu", function () {
            (s = !0), cancelAnimationFrame(e), (r = !1);
          }),
          n(i, "mousedown", function () {
            s = !1;
          }),
          n(i, "selectstart", function () {
            s || (cancelAnimationFrame(e), (r = !0));
          }),
          n(window, "mouseup blur", function () {
            cancelAnimationFrame(e), (r = !1), (s = !1);
          }),
          ...
          i(n, "touchmove", function (e) {
            if (!z || z === t) {
              ...
              t.addTransformableMomentum(i, r, e, function (n) {
                n && e.cancelable && (e.preventDefault(), (z = t));
              });
            }
          }),
          i(n, "touchcancel touchend", function (n) {
            var i = o.getEasingDistance(e);
            t.addTransformableMomentum(i.x, i.y, n),
          ...
          function (e) {
            var n = (function (t) {
                if ("deltaX" in t) {
                  var e = W(t.deltaMode);
                  return {
                    x: (t.deltaX / F.STANDARD) * e,
                    y: (t.deltaY / F.STANDARD) * e,
                  };
                }
                return "wheelDeltaX" in t
                  ? { x: t.wheelDeltaX / F.OTHERS, y: t.wheelDeltaY / F.OTHERS }
                  : { x: 0, y: t.wheelDelta / F.OTHERS };
              })(e),
              o = n.x,
              i = n.y;
            t.addTransformableMomentum(o, i, e, function (t) {
              t && e.preventDefault();
            });
          },
        );
      ...
      var F = { STANDARD: 1, OTHERS: -3 },
        ...
        U = (function () {
            ...
            (this.options = new T(e)),
              ...
              (this._plugins = (function (t, e) {
                return Array.from(L.order)
                  ...
                  .map(function (n) {
                    var o = new (0, L.constructors[n])(t, e[n]);
                    return (e[n] = o.options), o;
                  });
              })(this, this.options.plugins));
            var i = t.scrollLeft,
              r = t.scrollTop;
            (t.scrollLeft = t.scrollTop = 0),
              this.setPosition(i, r, { withoutCallbacks: !0 });
          ...
          return (
              ...
              return (function (t) {
                ...
                return {
                  ...
                  content: {
                    ...
                    height:
                      n.offsetHeight - n.clientHeight + n.scrollHeight + r,
                  },
                };
              })(this);
            }),
            (t.prototype.update = function () {
              !(function (t) {
                var e = t.getSize(),
                  ...
                  o = t.containerEl.getBoundingClientRect(),
                  i = {
                    top: Math.max(o.top, 0),
                    right: Math.min(o.right, window.innerWidth),
                    bottom: Math.min(o.bottom, window.innerHeight),
                    left: Math.max(o.left, 0),
                  };
                (t.size = e),
                  (t.limit = n),
                  (t.bounding = i),
            ...
            (t.prototype.isVisible = function (t) {
              return (function (t, e) {
                var n = t.bounding,
                  ...
                  r = Math.max(n.left, o.left),
                  s = Math.min(n.right, o.right);
                return i < Math.min(n.bottom, o.bottom) && r < s;
              })(this, t);
            }),
            (t.prototype.setPosition = function (t, e, n) {
              ...
              var i = (function (t, e, n) {
                ...
                return (
                  ...
                  e !== i.x && a.xAxis.show(),
                  n !== i.y && a.yAxis.show(),
                  o.alwaysShowTracks || a.autoHideOnIdle(),
                  e === i.x && n === i.y
                    ? null
                    : ((i.x = e),
                      (i.y = n),
            ...
            (t.prototype.scrollTo = function (t, e, n, o) {
              void 0 === t && (t = this.offset.x),
                void 0 === e && (e = this.offset.y),
                void 0 === n && (n = 0),
                void 0 === o && (o = {}),
                (function (t, e, n, o, i) {
                  ...
                  cancelAnimationFrame(M.get(t)),
                    (function e() {
                      var n = Date.now() - y,
                        i = o ? a(Math.min(n / o, 1)) : 1;
                      if ((t.setPosition(h + p * i, d + m * i), n >= o))
              ...
              void 0 === e && (e = {}),
                (function (t, e, n) {
                  ...
                  if (e && p.contains(e)) {
                    ...
                    if (!a || !t.isVisible(e)) {
                      var w = r ? b.top - m.top - c : b.bottom - m.bottom + d;
                      t.setMomentum(b.left - m.left - f, g(w, -y.y, v.y - y.y));
                    }
                  }
                })(this, t, e);
            }),
            ...
            (t.prototype.addTransformableMomentum = function (t, e, n, o) {
              ...
              var i = this._plugins.reduce(
                ...
                r = !this._shouldPropagateMomentum(i.x, i.y);
              r && this.addMomentum(i.x, i.y), o && o.call(this, r);
            }),
            ...
            (t.prototype._nextTick = function (t) {
              var e = this.options,
                ...
                i = n[t],
                r = o[t];
              if (Math.abs(r) <= 0.1) return { momentum: 0, position: i + r };
              var s = r * (1 - e.damping);
              return (
                e.renderByPixels && (s |= 0),
                { momentum: s, position: i + r - s }
              );
            }),
            a([_(100, !0)], t.prototype, "_updateDebounced", null),
            t
          );
        })(),
        G = "smooth-scrollbar-deluxe-style",
        V = !1;
      function q() {
      ...
      var J = (function (t) {
        ...
        return (
          ...
          (e.init = function (t, e) {
            ...
            return q(), Y.has(t) ? Y.get(t) : new U(t, e);
          }),
          ...
          (e.detachStyle = function () {
            return (function () {
              if (V && "undefined" != typeof window) {
                ...
                t && t.parentNode && (t.parentNode.removeChild(t), (V = !1));
              }
            })();
          }),
          (e.version = "11.0.0"),
